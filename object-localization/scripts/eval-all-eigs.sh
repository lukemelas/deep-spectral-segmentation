...
# eigs_dir="../preprocess/extract/data/VOC2007/eigs"
# for d in $(ls ${eigs_dir} | grep laplacian)
# do
#     echo $d
#     ls  ${eigs_dir}/${d}  | wc
...
# for d in $(ls ${eigs_dir} | grep laplacian)
# do
#     python main.py --eigenseg --precomputed_eigs_dir ${eigs_dir}/${d} --which_matrix laplacian --dataset VOC07 --name $d --skip_if_exists
# done


# eigs_dir="../preprocess/extract/data/VOC2007/eigs"; d="laplacian_dino_vitb16--out_features"; python main.py --eigenseg --precomputed_eigs_dir ${eigs_dir}/${d} --which_matrix laplacian --dataset VOC07 --name $d --skip_if_exists
