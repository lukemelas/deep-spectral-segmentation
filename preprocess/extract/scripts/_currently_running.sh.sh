...
for ds in 8  # 16  # 8 16
do 
    for model in dino_vitb8  # mocov3_vits16 mocov3_vitb16 dino_vits16 dino_vitb16 dino_vits8 dino_vitb8
    do 
        ...
        do 
            ...
            do 
                ...
                do 
                    for lam in 0.0 1.0 2.0 10.0    #  20.0 50.0 100.0 0.0 1.0 2.0 10.0
                    do
                        echo "******************"
                        echo "model=${model}"
                        echo "ds=${ds}"
...
for ds in 8  # 16  # 8 16
do 
    for model in dino_vits8 dino_vitb8  # mocov3_vits16 mocov3_vitb16 dino_vits16 dino_vitb16 dino_vits8 dino_vitb8
    do 
        for norm in normalize  # nonormalize 
        do 
            for thresh in threshold_at_zero  # nothreshold_at_zero 
            do 
                for lapnorm in lapnorm  # nolapnorm 
                do 
                    for lam in 5.0 8.0        #  20.0 50.0 100.0 0.0 1.0 2.0 10.0
                    do
                        echo "******************"
                        echo "model=${model}"
                        echo "ds=${ds}"
    ...
    do 
        ...
        do 
            ...
            do 
                for lapnorm in lapnorm  # nolapnorm 
                do 
                    for lam in 3.0 4.0 7.0 15.0  #  20.0 50.0 100.0 0.0 1.0 2.0 10.0
                    do
                        echo "******************"
                        echo "model=${model}"
                        echo "ds=${ds}"
