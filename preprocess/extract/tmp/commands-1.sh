...
# # Baseline (this took forever to run)
# python extract.py extract_multi_region_segmentations \
# --non_adaptive_num_segments 15 \
# --features_dir "./data/VOC2012/features/dino_vits16" \
# --eigs_dir "./data/VOC2012/eigs/matting_laplacian_dino_vits16_8x_lambda_10" \
# --output_dir "./data/VOC2012/multi_region_segmentation/dino_vits16_baseline_fixed_15" \
# --kmeans_baseline True
...
--features_dir "./data/VOC2012/features/dino_vits16" \
--eigs_dir "./data/VOC2012/eigs/matting_laplacian_dino_vits16_8x_lambda_10" \
--output_dir "./data/VOC2012/multi_region_segmentation/dino_vits16_8x_lambda_10_fixed_15"
...
--output_file "./data/VOC2012/multi_region_bboxes/dino_vits16_8x_lambda_10_fixed_15/bboxes_e2_d5.pth"

python extract.py extract_bbox_features \
--model_name dino_vits16 \
--images_root "./data/VOC2012/images" \
--bbox_file "./data/VOC2012/multi_region_bboxes/dino_vits16_8x_lambda_10_fixed_15/bboxes_e2_d5.pth" \
--output_file "./data/VOC2012/multi_region_bboxes/dino_vits16_8x_lambda_10_fixed_15/bbox_features_e2_d5.pth" \
...
--output_file "./data/VOC2012/multi_region_bboxes/dino_vits16_8x_lambda_10_fixed_15/bbox_clusters_e2_d5_pca_0_s0.pth" \

python extract.py extract_semantic_segmentations \
--segmentations_dir "./data/VOC2012/multi_region_segmentation/dino_vits16_8x_lambda_10_fixed_15" \
--bbox_clusters_file "./data/VOC2012/multi_region_bboxes/dino_vits16_8x_lambda_10_fixed_15/bbox_clusters_e2_d5_pca_0_s0.pth" \
--output_dir "./data/VOC2012/semantic_segmentations/patches/dino_vits16_8x_lambda_10_fixed_15/segmaps_e2_d5_pca_0_s0" \
